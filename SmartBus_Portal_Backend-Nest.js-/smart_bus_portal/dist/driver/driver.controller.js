...
let DriverController = class DriverController {
    ...
    async update(id, updateDriverDto, file) {
        try {
            ...
            throw new common_1.HttpException('Failed to update driver', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    remove(id) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DriverController.prototype, "updateName", null);
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('nidImage', {
        ...
        fileFilter: (req, file, cb) => {
            if (!file) {
                cb(new common_1.BadRequestException('No file uploaded'), false);
                return;
            }
            if (!file.originalname.match(/\.(jpg|jpeg|png)$/)) {
                cb(new common_1.BadRequestException('Only JPG, JPEG, or PNG files are allowed'), false);
                return;
            }
            cb(null, true);
        },
